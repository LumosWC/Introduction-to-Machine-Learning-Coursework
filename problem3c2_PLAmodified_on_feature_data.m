...
for update = 1:maxupdate
    W = zeros(1,dplusone)';
    i=i+1;                   
    [singleweight,errorvector]=perceptron_modified2(X1_train,Y1_train,W,update);
...
figure;
plot(m,errorvector);
title('3c2-Training Data - 2D Features-pocket');
...
u = 1:maxupdate;
plot(u,testerror);
title('3c2-Testing Data - 2D Features-pocket');
xlabel('Number of Updates');
